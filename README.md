...
тест не идёт, от чего то пишет collected 0 items - проблема всё так же актуальна. Может быть не хватате плгаина, задал вопрос наставнику, решения пока не нашли.
